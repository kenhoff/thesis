...
\bibitem{bloom}Bloom, Benjamin S. ``Taxonomy of Educational Objectives; the Classification of Educational Goals,''. New York: Longmans, Green, 1956. Print.
\bibitem{serious} Breuer, Johannes, and Gary Bente. ``Why so Serious? On the Relation of Serious Games and Learning.'' Eludamos. Journal for Computer Game Culture 4.1 (2010): 7-24. Eludamos. Journal for Computer Game Culture. Web. 02 July 2013.
\bibitem{turk_guide} Buhrmester, Michael. ``Amazon Mechanical Turk Guide for Social Scientists.'' Web. \textless \url{http://homepage.psy.utexas.edu/homepage/faculty/gosling/reprints/MTurkhowto.pdf}\textgreater.
...
\bibitem{flow} Csikszentmihalyi, Mihaly. ``Finding Flow.'' Psychology Today. 14 June 2012. Web. 02 July 2013.
\bibitem{review} Dondlinger, Mary Jo. ``Educational Video Game Design: A Review of the Literature.'' Journal of Applied Educational Technology 4.1 (2007). Print.
\bibitem{extracredits} Floyd, Daniel, and James Portnow. ``Tangential Learning.'' Season 2, Ep. 9 - Tangential Learning. Web. 02 July 2013.
...
\bibitem{interrater1} Hallgren, Kevin A. ``Computing Inter-Rater Reliability for Observational Data: An Overview and Tutorial.'' NCBI. U.S. National Library of Medicine, 23 July 2012. Web. 21 Nov. 2013.
\bibitem{crowdsourcing} Hyman, Paul. ``Communications of the ACM.'' Software Aims to Ensure Fairness in Crowdsourcing Projects. Communications of the ACM, Aug. 2013. Web. 21 Nov. 2013.
...
\bibitem{interrater2} ``The Measurement of Inter-rater Agreement.'' Web. \textless \url{http://hpm.fk.ugm.ac.id/hpmlama/images/Biostatistik/Tutorial\_4\_AS/2-chapter18.pdf}\textgreater.
\bibitem{paras} Paras, Brad, and Jim Bizzocchi. ``Game, Motivation, and Effective Learning: An Integrated Model for Educational Game Design.'' Proc. of DiGRA 2005 Conference: Changing Views – Worlds in Play. 2 June 2005. Web. 2 July 2013.
...
\bibitem{tdist1} Ammann, Larry. ``Hypothesis Tests to Compare Means of Two Populations - Paired Samples." Hypothesis Tests to Compare Means of Two Populations - Paired Samples. N.p., 20 Nov. 2013. Web. 05 Dec. 2013. \textless \url{http://www.utdallas.edu/~ammann/stat3355/node35.html} \textgreater.
\bibitem{tdist2} Lane, David M. ``T Distribution." T Distribution. N.p., n.d. Web. 05 Dec. 2013. \textless \url{http://onlinestatbook.com/2/estimation/t_distribution.html} \textgreater.
\bibitem{benchmarks} Gwet, Kilem L. ``Benchmarking Inter-Rater Reliability Coeﬃcients." Handbook of Inter-Rater Reliability. N.p., 2012. Web. 5 Dec. 2013. \textless \url{http://www.agreestat.com/book3/bookexcerpts/chapter6.pdf} \textgreater.
