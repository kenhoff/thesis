...
\chapter{Conclusion}
	...
	\section{What worked well}
		...
		\subsection{Inter-rater Reliability}
			...
			Inter-rater Reliability turned out to be a very effective way to measure how well the rubric was designed. Even if it wasn't designed very well, it was fortunate that I found 
	...
	\section{Personal learnings}
		...
		\subsection{Automation and analysis with Python and visualization with PyPlot}

			First, the information for the quizzes, surveys, rubric, and games were created in a JSON format. From this format, the final surveys and quizzes specific to each game can be created, while also generating some \LaTeX documents with the exact same format.
